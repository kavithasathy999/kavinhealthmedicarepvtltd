    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 antialiased selection:bg-[#50ad77]/20 selection:text-[#50ad77] overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-sans antialiased bg-white min-h-screen">
        <div className="mb-6">
          ...
          <p className="text-base md:text-lg text-slate-500 font-normal">
          ...
          {blogData.map((blog) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="text-[11px] font-extrabold text-[#50ad77] uppercase tracking-widest mb-3">
                  {blog.read_time?.toUpperCase()}
                </div>
                <h3 className="text-xl font-bold text-slate-900 leading-snug mb-3 font-serif min-h-[56px] line-clamp-2">
                  {blog.title}
                </h3>
